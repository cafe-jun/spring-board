...
class ArticleServiceTest {
    ...
    void givenModifiedArticleInfo_whenUpdatingArticle_thenUpdatesArticle() {
        //given
        Article article = createArticle();
        ArticleDto dto = createArticleDto("title1","updateContent","#nodejs");
        given(articleRepository.getReferenceById(dto.id())).willReturn(article); /// 해당 코드는 크게 의미가 없다 (호출을 하였는가 ? )  실제 DB 테스트 X -> Unit 테스트가 아님
    ...
    void givenNonexistentArticleInfo_whenUpdatingArticle_thenLogsWarningAndDoesNothing() {
        //given
        ArticleDto dto = createArticleDto("new title","new Content","#nodejs");
    ...
    @DisplayName("해시태그를 조회하면, 유니크 해시태그를 반환한다")
    @Test
